...
static const _PolynomialTrajectory_type_support_symbol_names_t _PolynomialTrajectory_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quadrotor_msgs, msg, PolynomialTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quadrotor_msgs, msg, PolynomialTrajectory)),
  }
};
...
{
  return &::quadrotor_msgs::msg::rosidl_typesupport_cpp::PolynomialTrajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, quadrotor_msgs, msg, PolynomialTrajectory)() {
  return get_message_type_support_handle<quadrotor_msgs::msg::PolynomialTrajectory>();
}
