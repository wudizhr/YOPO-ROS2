...
bool quadrotor_msgs__msg__corrections__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadrotor_msgs.msg._corrections.Corrections", full_classname_dest, 43) == 0);
  }
  quadrotor_msgs__msg__Corrections * ros_message = _ros_message;
  {  // kf_correction
...
{
  /* NOTE(esteve): Call constructor of Corrections */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("quadrotor_msgs.msg._corrections");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Corrections");
