...
bool quadrotor_msgs__msg__status_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadrotor_msgs.msg._status_data.StatusData", full_classname_dest, 42) == 0);
  }
  quadrotor_msgs__msg__StatusData * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of StatusData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("quadrotor_msgs.msg._status_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StatusData");
