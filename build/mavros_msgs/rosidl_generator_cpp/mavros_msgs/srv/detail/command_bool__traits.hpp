...
inline std::string to_yaml(const CommandBool_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use mavros_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const mavros_msgs::srv::CommandBool_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  mavros_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use mavros_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const mavros_msgs::srv::CommandBool_Event & msg)
{
  return mavros_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<mavros_msgs::srv::CommandBool_Event>()
{
  return "mavros_msgs::srv::CommandBool_Event";
}

template<>
inline const char * name<mavros_msgs::srv::CommandBool_Event>()
{
  return "mavros_msgs/srv/CommandBool_Event";
}

template<>
struct has_fixed_size<mavros_msgs::srv::CommandBool_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<mavros_msgs::srv::CommandBool_Event>
  : std::integral_constant<bool, has_bounded_size<mavros_msgs::srv::CommandBool_Request>::value && has_bounded_size<mavros_msgs::srv::CommandBool_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<mavros_msgs::srv::CommandBool_Event>
  : std::true_type {};
