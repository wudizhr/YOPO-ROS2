...
#ifndef MAVROS_MSGS__SRV__DETAIL__COMMAND_BOOL__TYPE_SUPPORT_H_
#define MAVROS_MSGS__SRV__DETAIL__COMMAND_BOOL__TYPE_SUPPORT_H_
...
#endif  // MAVROS_MSGS__SRV__DETAIL__COMMAND_BOOL__TYPE_SUPPORT_H_
