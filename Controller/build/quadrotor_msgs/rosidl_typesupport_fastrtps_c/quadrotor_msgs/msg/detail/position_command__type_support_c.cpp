...
#include "quadrotor_msgs/msg/detail/position_command__rosidl_typesupport_fastrtps_c.h"
...
using _PositionCommand__ros_msg_type = quadrotor_msgs__msg__PositionCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: trajectory_flag
  {
    cdr << ros_message->trajectory_flag;
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: trajectory_flag
  {
    size_t item_size = sizeof(ros_message->trajectory_flag);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = quadrotor_msgs__msg__PositionCommand;
    is_plain =
      (
      offsetof(DataType, trajectory_flag) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const quadrotor_msgs__msg__PositionCommand * ros_message = static_cast<const quadrotor_msgs__msg__PositionCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_quadrotor_msgs__msg__PositionCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  quadrotor_msgs__msg__PositionCommand * ros_message = static_cast<quadrotor_msgs__msg__PositionCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_quadrotor_msgs__msg__PositionCommand(cdr, ros_message);
}

static uint32_t _PositionCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_quadrotor_msgs__msg__PositionCommand(
...
static size_t _PositionCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_quadrotor_msgs__msg__PositionCommand(
