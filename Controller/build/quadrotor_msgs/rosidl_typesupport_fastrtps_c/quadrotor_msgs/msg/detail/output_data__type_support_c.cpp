...
#include "quadrotor_msgs/msg/detail/output_data__rosidl_typesupport_fastrtps_c.h"
...
using _OutputData__ros_msg_type = quadrotor_msgs__msg__OutputData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: pressure_dheight
  {
    cdr << ros_message->pressure_dheight;
  }

  // Field name: pressure_height
  {
  ...
  // Field name: radio_channel
  {
    size_t size = 8;
    auto array_ptr = ros_message->radio_channel;
...
size_t get_serialized_size_quadrotor_msgs__msg__OutputData(
  ...
  size_t current_alignment)
{
  const _OutputData__ros_msg_type * ros_message = static_cast<const _OutputData__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = quadrotor_msgs__msg__OutputData;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const quadrotor_msgs__msg__OutputData * ros_message = static_cast<const quadrotor_msgs__msg__OutputData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_quadrotor_msgs__msg__OutputData(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  quadrotor_msgs__msg__OutputData * ros_message = static_cast<quadrotor_msgs__msg__OutputData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_quadrotor_msgs__msg__OutputData(cdr, ros_message);
}

static uint32_t _OutputData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_quadrotor_msgs__msg__OutputData(
...
static size_t _OutputData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_quadrotor_msgs__msg__OutputData(
...
static message_type_support_callbacks_t __callbacks_OutputData = {
  "quadrotor_msgs::msg",
  "OutputData",
...
static rosidl_message_type_support_t _OutputData__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_OutputData,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, quadrotor_msgs, msg, OutputData)() {
  return &_OutputData__type_support;
}
