...
#include "quadrotor_msgs/msg/detail/trpy_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const quadrotor_msgs::msg::TRPYCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  quadrotor_msgs::msg::TRPYCommand & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_quadrotor_msgs
max_serialized_size_TRPYCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = quadrotor_msgs::msg::TRPYCommand;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_quadrotor_msgs
max_serialized_size_key_TRPYCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static bool _TRPYCommand__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const quadrotor_msgs::msg::TRPYCommand *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _TRPYCommand__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<quadrotor_msgs::msg::TRPYCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TRPYCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const quadrotor_msgs::msg::TRPYCommand *>(
...
static size_t _TRPYCommand__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_TRPYCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TRPYCommand__callbacks = {
  "quadrotor_msgs::msg",
  "TRPYCommand",
  _TRPYCommand__cdr_serialize,
  _TRPYCommand__cdr_deserialize,
  _TRPYCommand__get_serialized_size,
  _TRPYCommand__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _TRPYCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TRPYCommand__callbacks,
...
{
  return &quadrotor_msgs::msg::typesupport_fastrtps_cpp::_TRPYCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quadrotor_msgs, msg, TRPYCommand)() {
  return &quadrotor_msgs::msg::typesupport_fastrtps_cpp::_TRPYCommand__handle;
}
