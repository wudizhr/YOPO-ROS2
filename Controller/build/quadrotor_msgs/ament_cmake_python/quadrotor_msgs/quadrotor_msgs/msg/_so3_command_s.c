...
bool quadrotor_msgs__msg__so3_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // k_r
    PyObject * field = PyObject_GetAttrString(_pymsg, "k_r");
    if (!field) {
      return false;
    }
    {
  ...
  {  // k_om
    PyObject * field = PyObject_GetAttrString(_pymsg, "k_om");
    if (!field) {
      return false;
    }
    {
...
PyObject * quadrotor_msgs__msg__so3_command__convert_to_py(void * raw_ros_message)
{
  ...
  {  // k_r
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "k_r");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    double * src = &(ros_message->k_r[0]);
    memcpy(dst, src, 3 * sizeof(double));
    Py_DECREF(field);
  }
  {  // k_om
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "k_om");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
