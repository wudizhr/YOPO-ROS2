...
// IWYU pragma: private, include "mavros_msgs/msg/state.h"


#ifndef MAVROS_MSGS__MSG__DETAIL__STATE__FUNCTIONS_H_
#define MAVROS_MSGS__MSG__DETAIL__STATE__FUNCTIONS_H_
 ...
 * calls
 * mavros_msgs__msg__State__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mavros_msgs
mavros_msgs__msg__State *
mavros_msgs__msg__State__create(void);

/// Destroy msg/State message.
/**
 * It calls
 * mavros_msgs__msg__State__fini()
 ...
 * mavros_msgs__msg__State__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mavros_msgs__msg__State__Sequence__fini()
 * on the array,
...
#endif  // MAVROS_MSGS__MSG__DETAIL__STATE__FUNCTIONS_H_
