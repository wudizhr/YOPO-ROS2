...
bool quadrotor_msgs__msg__serial__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadrotor_msgs.msg._serial.Serial", full_classname_dest, 33) == 0);
  }
  quadrotor_msgs__msg__Serial * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Serial */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("quadrotor_msgs.msg._serial");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Serial");
