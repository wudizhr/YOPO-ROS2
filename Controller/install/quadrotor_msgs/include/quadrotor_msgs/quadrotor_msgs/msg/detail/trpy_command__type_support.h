...
#ifndef QUADROTOR_MSGS__MSG__DETAIL__TRPY_COMMAND__TYPE_SUPPORT_H_
#define QUADROTOR_MSGS__MSG__DETAIL__TRPY_COMMAND__TYPE_SUPPORT_H_
...
#endif  // QUADROTOR_MSGS__MSG__DETAIL__TRPY_COMMAND__TYPE_SUPPORT_H_
