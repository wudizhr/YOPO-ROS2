...
enum
{
  mavros_msgs__srv__SetMode_Event__request__MAX_SIZE = 1
};
// response
enum
{
  mavros_msgs__srv__SetMode_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetMode in the package mavros_msgs.
typedef struct mavros_msgs__srv__SetMode_Event
{
  service_msgs__msg__ServiceEventInfo info;
  mavros_msgs__srv__SetMode_Request__Sequence request;
  mavros_msgs__srv__SetMode_Response__Sequence response;
} mavros_msgs__srv__SetMode_Event;

// Struct for a sequence of mavros_msgs__srv__SetMode_Event.
typedef struct mavros_msgs__srv__SetMode_Event__Sequence
{
